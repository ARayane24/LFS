...
export DO_YOU_WANT_BACKUP_OS_REC=\"Colse to the final steps ${OK}it's recommended${NO_STYLE} to have backup for the progress [requier about 5GB]\"
...
export NO_BACK_UP_OS=\"${OK}You indicated that you don't want us to backup the progress\n${NO_STYLE}\"
